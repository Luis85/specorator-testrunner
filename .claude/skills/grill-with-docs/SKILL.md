...
### Cross-reference with code and design docs

When the user states how something works, check whether the code and the design docs agree. If you find a contradiction, surface it: "Your code cancels entire Orders, but you just said partial cancellation is possible — which is right?"
...
The Solution Design also carries a short list of V1 architectural decisions (AD-1…AD-N in §25). Those are tactical V1 configuration choices (package manager, browser matrix, fixture strategy, etc.) and stay inline. Long-form architectural decisions go to `docs/adr/`.
